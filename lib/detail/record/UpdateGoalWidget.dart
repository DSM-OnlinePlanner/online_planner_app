...
class UpdateGoalWidget extends StatefulWidget {
  ...
  UpdateGoalWidget(this.goalId, this.content);

  @override
  _UpdateGoalWidgetState createState() => _UpdateGoalWidgetState(goalId, content);
}
...
class _UpdateGoalWidgetState extends State<UpdateGoalWidget> {
  ...
  _UpdateGoalWidgetState(this.goalId, this.content);
